...
echo ""
echo -e "  ${YELLOW}${BOLD}IMPORTANT — first launch only:${NC}"
echo -e "    When Obsidian opens, it will ask about community plugins."
echo -e "    Click ${BOLD}'Turn off restricted mode'${NC} then ${BOLD}'Trust author and enable plugins'${NC}."
echo -e "    This activates all 11 plugins. You only need to do this once."
echo ""
